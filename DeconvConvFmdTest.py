...
def deconv_conv_comparison(batch_size=64, epochs=10, lr=0.1, validation_split=0.4):
    img_height = 384
    img_width = 512
    ...
    model1.evaluate(ds_validation, batch_size=batch_size, verbose=2)
...
def deconv_conv_comparison_validation(batch_size=64, epochs=10, lr=0.1, validation_split=0.4):
    ...
    # Train DNN
    history = model.fit(ds_train, validation_split, epochs=epochs, verbose=2)
    ...
    # Train CNN
    history1 = model1.fit(ds_train, validation_split, epochs=epochs, verbose=2)
...
if __name__ == '__main__':
    ...
    deconv_conv_comparison(batch_size=10, epochs=epochs, lr=lr, validation_split=validation_split)
